        ...
        <Card>
          <CardHeader className="d-flex justify-content-between align-items-center gap-1">
            <CardTitle as={'h4'} className="flex-grow-1">
              Restaurants Menu Category
            </CardTitle>
            <Link href="/pages/restaurants-menu-category/restaurants-menu-category-add" className="btn btn-sm btn-primary">
              Add Category
            </Link>
          </CardHeader>
          <div>
                    ...
                    <tr key={item.id}>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <Link href="/pages/restaurants-menu-category/restaurants-menu-category-edit" className="btn btn-soft-primary btn-sm">
